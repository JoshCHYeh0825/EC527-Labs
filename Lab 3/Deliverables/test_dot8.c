...
void dot8_4(array_ptr v0, array_ptr v1, data_t *dest)
{
  ...
  while (cnt >= 4*VSIZE) {
    ...
    accum0 = accum0 + (v0chunk0 * v1chunk0) + (v0chunk1 * v1chunk1);
    accum1 = accum1 + (v0chunk2 * v1chunk2) + (v0chunk3 * v1chunk0);
...
void dot8_8(array_ptr v0, array_ptr v1, data_t *dest)
{
  ...
  while (cnt >= 8*VSIZE) {
    ...
    accum0 = accum0 + (v0chunk0 * v1chunk0) + (v0chunk1 * v1chunk1) + (v0chunk2 * v1chunk2) + (v0chunk3 * v1chunk3);
    accum1 = accum1 + (v0chunk4 * v1chunk4) + (v0chunk5 * v1chunk5) + (v0chunk6 * v1chunk6) + (v0chunk7 * v1chunk7);
